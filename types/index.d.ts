...
declare module "@google-cloud/datastore" {
  ...
  class Datastore extends DatastoreRequest {
    ...
    static int(value: string | number): DatastoreInt;

    static isInt(value: any): value is DatastoreInt;

    static double(value: string | number): DatastoreDouble;

    static isDouble(value: any): value is DatastoreDouble;

    static geoPoint(coordinates: DatastoreCoords): DatastoreGeopoint;

    static isGeoPoint(value: any): value is DatastoreGeopoint;

    static isKey(value: any): value is DatastoreKey;
